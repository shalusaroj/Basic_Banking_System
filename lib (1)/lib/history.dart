...
class HistoryPageState extends State<HistoryPage> {
  List<HistoryModel> histories = [
    HistoryModel('images/ico_send_money.png', 'Paid to', 'Juli', 500.0,
        '04 April 2020', 'images/ico_logo_red.png'),
    HistoryModel('images/ico_send_money.png', 'Paid to', 'Priti', 999.0,
    ...
    HistoryModel('images/ico_receive_money.png', 'Received from', 'Supriya', 30.0,
