...
class ProfilePageState extends State<ProfilePage> {
  final List<BankCardModel> cards = [
    BankCardModel('images/bg_red_card.png', 'Shalini Saroj',
        '4221 5168 7464 2283', '08/20', 10000000),
    BankCardModel('images/bg_blue_circle_card.png', 'Shalini Saroj',
        '4221 5168 7464 2283', '08/20', 10000000),
    BankCardModel('images/bg_purple_card.png', 'Shalini Saroj',
        '4221 5168 7464 2283', '08/20', 10000000),
    BankCardModel('images/bg_blue_card.png', 'Shalini Saroj',
        '4221 5168 7464 2283', '08/20', 10000000),
  ];
